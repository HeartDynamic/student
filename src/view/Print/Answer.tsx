        ...
        return (
            <Container>
                ...
                <Table ref={componentRef}>
                    <Thead>
                        <Tr>
                            <Th>{answerStore.testProblemData.name}</Th>
                        </Tr>
                        <Tr>
                            <Td>
                                <SpanWrap>
                    ...
                    <Tbody>
                        <VolumeTopic
                            data={{
                                arr: answerStore.testProblemData.choiceProblems,
                                typeName: '单选题',
                            }}
                        ></VolumeTopic>
                        <VolumeTopic
                            data={{
                                arr: answerStore.testProblemData.checkboxProblems,
                                typeName: '多选题',
                            }}
                        ></VolumeTopic>
                        <VolumeTopic
                            data={{
                                arr: answerStore.testProblemData.judgeProblems,
                                typeName: '判断题',
                            }}
                        ></VolumeTopic>
                        <VolumeTopic
                            data={{
                                arr: answerStore.testProblemData.fillingProblems,
                                typeName: '填空题',
                            }}
                        ></VolumeTopic>
                        <VolumeTopic
                            data={{
                                arr: answerStore.testProblemData.shortAnswerProblems,
                                typeName: '简答题',
                            }}
                        ></VolumeTopic>
                    </Tbody>
